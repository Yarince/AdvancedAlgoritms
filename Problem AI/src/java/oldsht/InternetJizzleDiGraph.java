package oldsht;
/**
 * Source: https://www.quora.com/How-can-I-implement-trees-and-graphs-in-Java
 */
...
public class InternetJizzleDiGraph<V> {
...
/*
    public void allTopSorts(int n, List<Integer> loc, List<V> p, HashMap<Integer, V> m) {
        int k;
        int k1;
...
//        InternetJizzleDiGraph<Integer> graph = new InternetJizzleDiGraph<>();
//
//        graph.add(0, 1);
//        graph.add(0, 2);
//        graph.add(0, 3);
...
//        graph.add(5, 6);    // Tetrahedron with tail
        ...
        var graph = new InternetJizzleDiGraph<Character>();
