...
public class BitonicTSP {
    ...
    static ArrayList<Point> sortedVertices; //the sorted list of points
    double distance;
    ...
    public void sortVertices() {
        ...
        sortedVertices = (ArrayList<Point>) graph.pairs.clone();
        Point t1;
        Point t2;
        int i = 0;
    ...
    public double getEuclideanDist(Point v1, Point v2) {
